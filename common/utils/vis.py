...
def vis_keypoints(img, kps, skeleton, filename, score_thr=0.4, line_width=3, circle_rad = 3, save_path=None):
...
def vis_3d_keypoints(kps_3d, skeleton, filename, score_thr=0.4, line_width=3, circle_rad=3):
